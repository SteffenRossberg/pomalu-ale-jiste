...
class PortfolioState:
    ...
    def step(self, action):
        ...
        if action == Actions.Buy and self._stock_count == 0 and count > 0:
            returns = ((self._top_price / price) - 1.0)
            ...
            returns = ((price / self._buy_price) - 1.0)
            returns *= 1.0 - (self.tax_rate if returns > 0.0 else 0.0)
            ...
            if (self.__train_level & TrainingLevels.Skip) == TrainingLevels.Skip:
                ...
                imaginary_returns = ((price / self._top_price) - 1.0)
                imaginary_returns *= 1.0 - (self.tax_rate if imaginary_returns > 0.0 else 0.0)
                if imaginary_returns > 0.0:
                    reward += imaginary_returns * 100.0
            ...
            if (self.__train_level & TrainingLevels.Hold) == TrainingLevels.Hold:
                ...
                imaginary_returns = ((price / self._buy_price) - 1.0)
                imaginary_returns *= 1.0 - (self.tax_rate if imaginary_returns > 0.0 else 0.0)
                if imaginary_returns > 0.0:
                    reward += imaginary_returns * 100.0
        self._offset += 1
